            ...
            return (
              (museum.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
                ...
                <TouchableOpacity
                  ...
                  style={
                    index === museums.length - 1 ? { paddingBottom: 400 } : {}
                  }
                >
                  <View style={[styles.museum]}>
                    <View style={[styles.museumHeader]}>
                      <ZailaText
                        style={[styles.museumName, styles.alignCenter]}
                      >
                        {museum.name}
                      </ZailaText>
                      <ZailaText
                    ...
                    <View style={[styles.museumInfo]}>
                          ...
                          <Image
                            source={
                              categories.find(
                                (category) =>
                                  category.name ===
                                  museum.museum_category.categoryName
                              ).img
                            }
                          />
                        </View>
                      ...
                      <View style={[styles.museumDescWrapper]}>
                        {/* <ZailaText style={styles.paraTextSize}>{museum.description}</ZailaText>
										<View> */}
                        <ZailaText
                          style={[styles.paraTextSize, styles.featuredHeading]}
                          weight="bold"
                        >
                          Current featuring:
                        </ZailaText>
                        <ZailaText
                          style={[styles.paraTextSize, styles.exhibitionInfo]}
                        >
